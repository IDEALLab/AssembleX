...
_SYSTEM_INSTRUCTIONS = (
    ...
    "   DO NOT describe any part by its color (e.g. 'the blue bracket', 'the "
    "green panel'). The parts are auto-assigned distinct colors purely so they "
    "are easy to tell apart in these renders; those colors do not exist on the "
    "real parts. Use the colors only to work out which part is which, then refer "
    "to each part by its given name and by its shape or function.\n"
